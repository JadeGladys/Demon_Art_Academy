...
namespace DemonArtAcademy.Models
{
    ...
    public partial class DemonArtAcademyDBEntities : DbContext
    {
        public DemonArtAcademyDBEntities()
            : base("name=DemonArtAcademyDBEntities")
        {
        }
        ...
        public virtual DbSet<teachingLoad> teachingLoads { get; set; }
